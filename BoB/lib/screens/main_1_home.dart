                    ...
                    content: Column(
                      ...
                      children: [
                        TextButton(
                            ...
                            child: Text('life3_0'.tr, style: TextStyle(color: Colors.black, fontFamily: 'NanumSquareRound'))
                        ),
                        ...
                        TextButton(
                          ...
                          child: Text('life3_1'.tr, style: TextStyle(color: Colors.black, fontFamily: 'NanumSquareRound')),
                        ),
                      ],
                    )
                )
